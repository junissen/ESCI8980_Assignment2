...
class Ucalculation():
    ...
    def U_normalization_forTh(self):
        ...
        while self.inquiry:
            ...
            print "236/233 measured ratio: " + str(self.six_three_mean_meas)
            print "236/233 measured 2s error: " + str(self.six_three_err_meas)
            print "235/233 normalized ratio: " + str(self.five_three_norm)
            print "235/233 normalized 2s error: " + str(self.five_three_norm_err)
            print "236/233 corrected ratio: " + str(self.six_three_corr)
            print "236/233 corrected 2s error: " + str(self.six_three_corr_err)
            break
    ...
    def U_normalization_forAge(self):
        ...
        while self.inquiry:
            ...
            print "235/233 normalized ratio : " + str(self.five_three_norm)
            print "235/233 normalized 2s error : " + str(self.five_three_norm_err)
            print "234/235 normalized and corrected ratio: " + str(self.four_five_normcorr)
            print "234/235 normalized and corrected 2s error : " + str(self.four_five_normcorr_err)
...
class Thcalculation():
    ...
    def Th_normalization_forAge(self):
        ...
        while self.inquiry:
            ...
            print "230/229 corrected and normalized ratio : " + str(self.zero_nine_corrnorm)
            print "230/229 corrected and normalized 2s error : " + str(self.zero_nine_corrnorm_err)
            print "232/229 corrected and normalized ratio: " + str(self.two_nine_corrnorm)
            print "232/229 corrected and normalized 2s error : " + str(self.two_nine_corrnorm_err)
...
class chemblank_values():
    ...
    def blank_calculate(self):
        ...
        self.chem_blank_zero = self.spike_nine_used * zero_nine_corr_spike 
        
        self.chem_blank_zero_err = abs(self.chem_blank_zero * zero_nine_corr_spike_err)
        
        while self.inquiry: 
            print "CHEMBLANK VALUES FOR AGE CALC: " 
            print "238U chemblank: " + str(self.chem_blank_eight) + " pmol"
            print "238U chemblank error: " + str(self.chem_blank_eight_err) + " pmol"
            print "232Th chemblank: " + str(self.chem_blank_two) + " pmol"
            print "232Th chemblank error: " + str(self.chem_blank_two_err) + " pmol"
            print "230Th chemblank: " + str(self.chem_blank_zero) + " fmol"
            print "230Th chemblank error: " + str(self.chem_blank_zero_err) + " fmol"
            break
